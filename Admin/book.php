                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Here you can Find all available Books Details and Block Book </p>
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
											<?php 
													...
													$r=mysqli_query($conn,"SELECT * FROM `book_info` WHERE `type`='Sell'");
                                        ...
                                        <tr>
													...
													<td><a class="pe-7s-lock" href="block_book.php?id=<?php echo $c['book_id']; ?>&status=<?php echo $c['status']; ?> "><td>
										</tr>
